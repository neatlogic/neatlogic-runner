...
public class ExecManager {
    ...
    public static void exec(CommandVo commandVo) throws Exception {
        ...
        //set command
        commandVo.setCommandList(Collections.singletonList(String.format("%s --jobid \"%s\" --execuser \"%s\" -p %s",COMMAND_AUTOEXEC,commandVo.getJobId(),commandVo.getExecUser(),filePath)));
