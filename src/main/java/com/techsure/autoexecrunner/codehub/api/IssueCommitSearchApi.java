		...
		if (CollectionUtils.isNotEmpty(retList)) {
			...
			retList.sort((o1, o2) -> {
				...
				if (CollectionUtils.isEmpty(commitList1) && CollectionUtils.isEmpty(commitList2)) {
					...
					JSONObject date1 = commitList1.getJSONObject(commitList1.size() - 1).getJSONObject("committerDate");
					JSONObject date2 = commitList2.getJSONObject(commitList2.size() - 1).getJSONObject("committerDate");
					...
					if (date1 == null && date2 == null) {
						...
						return Long.compare(date1.getLong("time"), date2.getLong("time"));
					}
				}
			});
		}
